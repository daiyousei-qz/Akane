...
namespace akane
{
    ...
    public:
        ...
        const Vec3f& X() const noexcept { return vx_; }
        const Vec3f& Y() const noexcept { return vy_; }
        const Vec3f& Z() const noexcept { return vz_; }
        const Vec3f& P() const noexcept { return p_; }
